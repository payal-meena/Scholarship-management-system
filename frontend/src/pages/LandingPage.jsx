import { ChevronLeft, Landmark, User } from 'lucide-react';
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 w-full px-6'>
            ...
            <div className='bg-white shadow-xl rounded-2xl p-8 text-center border-t-4 border-indigo-500'>
                ...
                <div className='space-y-4'>
                    <Link  to="/student-login" className='cursor-pointer block w-full bg-indigo-600 text-white py-3 rounded-xl font-semibold hover:bg-indigo-700 transition'>
                    Student Login
                    </Link>
                    <Link to="/student-signup" className='cursor-pointer block w-full bg-indigo-100 text-indigo-700 py-3 rounded-xl font-semibold hover:bg-indigo-200 transition'>
                    Student Signup
                    </Link>
                </div>
            </div>
            ...
            <div className='bg-white shadow-xl rounded-2xl p-8 text-center border-t-4 border-green-500'>
                ...
                <Link to="/admin-login" className='cursor-pointer block w-full bg-green-600 text-white py-3 rounded-xl font-semibold hover:bg-green-700 transition'>
                Admin Login
                </Link>
            </div>
        </div>
            <div className="mt-8 text-center">
                <Link to="/" className="cursor-pointer text-sm text-indigo-600 hover:text-indigo-800 transition">
